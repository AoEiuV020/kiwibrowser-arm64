...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_ui_resources_ResourceManager_clazz =
    0;
...
JNI_GENERATOR_EXPORT void Java_org_chromium_ui_resources_ResourceManager_nativeOnResourceReady(
    JNIEnv* env,
    jobject jcaller,
  ...
  return native->OnResourceReady(env, base::android::JavaParamRef<jobject>(env, jcaller), resType,
      resId, base::android::JavaParamRef<jobject>(env, bitmap), nativeResource);
}

JNI_GENERATOR_EXPORT void Java_org_chromium_ui_resources_ResourceManager_nativeRemoveResource(
    JNIEnv* env,
    jobject jcaller,
    jlong nativeResourceManagerImpl,
    jint resType,
  ...
  return native->RemoveResource(env, base::android::JavaParamRef<jobject>(env, jcaller), resType,
      resId);
}

JNI_GENERATOR_EXPORT void
    Java_org_chromium_ui_resources_ResourceManager_nativeClearTintedResourceCache(
    JNIEnv* env,
    jobject jcaller,
    jlong nativeResourceManagerImpl) {
  ResourceManagerImpl* native = reinterpret_cast<ResourceManagerImpl*>(nativeResourceManagerImpl);
  CHECK_NATIVE_PTR(env, jcaller, native, "ClearTintedResourceCache");
  return native->ClearTintedResourceCache(env, base::android::JavaParamRef<jobject>(env, jcaller));
}


static base::subtle::AtomicWord g_org_chromium_ui_resources_ResourceManager_create = 0;
static base::android::ScopedJavaLocalRef<jobject> Java_ResourceManager_create(JNIEnv* env, const
  ...
  CHECK_CLAZZ(env, org_chromium_ui_resources_ResourceManager_clazz(env),
      org_chromium_ui_resources_ResourceManager_clazz(env), NULL);
  jmethodID method_id = base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_STATIC>(
          env, org_chromium_ui_resources_ResourceManager_clazz(env),
          "create",
  ...
  jobject ret =
      env->CallStaticObjectMethod(org_chromium_ui_resources_ResourceManager_clazz(env),
          method_id, windowAndroid.obj(), staticResourceManagerPtr);
  jni_generator::CheckException(env);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static base::subtle::AtomicWord g_org_chromium_ui_resources_ResourceManager_destroy = 0;
...
static base::subtle::AtomicWord g_org_chromium_ui_resources_ResourceManager_resourceRequested = 0;
...
static base::subtle::AtomicWord g_org_chromium_ui_resources_ResourceManager_preloadResource = 0;
...
static base::subtle::AtomicWord g_org_chromium_ui_resources_ResourceManager_getNativePtr = 0;
