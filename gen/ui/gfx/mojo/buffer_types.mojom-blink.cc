...
GpuMemoryBufferHandle::GpuMemoryBufferHandle(
    ...
    AHardwareBufferHandlePtr android_hardware_buffer_handle_in)
    : type(std::move(type_in)),
      ...
      android_hardware_buffer_handle(std::move(android_hardware_buffer_handle_in)) {}
...
bool StructTraits<::gfx::mojom::blink::GpuMemoryBufferHandle::DataView, ::gfx::mojom::blink::GpuMemoryBufferHandlePtr>::Read(
  ...
  ::gfx::mojom::blink::GpuMemoryBufferHandlePtr result(::gfx::mojom::blink::GpuMemoryBufferHandle::New());
      ...
      if (!input.ReadAndroidHardwareBufferHandle(&result->android_hardware_buffer_handle))
        success = false;
  *output = std::move(result);
  return success;
}
