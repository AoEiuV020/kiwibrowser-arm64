...
bool NativePixmapHandle_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->fds, 1, validation_context)) {
    return false;
  }
...
bool GpuMemoryBufferHandle_Data::Validate(
  ...
  if (!::gfx::mojom::internal::GpuMemoryBufferType_Data
  ...
  if (!mojo::internal::ValidateStruct(object->android_hardware_buffer_handle, validation_context))
    return false;
