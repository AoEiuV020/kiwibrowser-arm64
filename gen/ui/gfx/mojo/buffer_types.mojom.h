...
class  AHardwareBufferHandle {
 public:
  ...
  template <typename T,
            typename std::enable_if<std::is_same<
                T, AHardwareBufferHandle>::value>::type* = nullptr>
  bool Equals(const T& other) const;

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AHardwareBufferHandle::DataView, std::vector<uint8_t>>(input);
  }
...
template <typename T,
          typename std::enable_if<std::is_same<
              T, AHardwareBufferHandle>::value>::type*>
...
GpuMemoryBufferHandlePtr GpuMemoryBufferHandle::Clone() const {
  return New(
      ...
      mojo::Clone(android_hardware_buffer_handle)
  );
}
...
bool GpuMemoryBufferHandle::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->mach_port, other_struct.mach_port))
    return false;
  if (!mojo::Equals(this->android_hardware_buffer_handle, other_struct.android_hardware_buffer_handle))
    return false;
  return true;
}
...
template <>
struct  StructTraits<::gfx::mojom::AHardwareBufferHandle::DataView,
                                         ::gfx::mojom::AHardwareBufferHandlePtr> {
  static bool IsNull(const ::gfx::mojom::AHardwareBufferHandlePtr& input) { return !input; }
  static void SetToNull(::gfx::mojom::AHardwareBufferHandlePtr* output) { output->reset(); }

  static  decltype(::gfx::mojom::AHardwareBufferHandle::buffer_handle)& buffer_handle(
       ::gfx::mojom::AHardwareBufferHandlePtr& input) {
    return input->buffer_handle;
  }

  static  decltype(::gfx::mojom::AHardwareBufferHandle::tracking_pipe)& tracking_pipe(
       ::gfx::mojom::AHardwareBufferHandlePtr& input) {
    return input->tracking_pipe;
  }

  static bool Read(::gfx::mojom::AHardwareBufferHandle::DataView input, ::gfx::mojom::AHardwareBufferHandlePtr* output);
};
...
struct  StructTraits<::gfx::mojom::GpuMemoryBufferHandle::DataView,
  ...
  static  decltype(::gfx::mojom::GpuMemoryBufferHandle::android_hardware_buffer_handle)& android_hardware_buffer_handle(
       ::gfx::mojom::GpuMemoryBufferHandlePtr& input) {
    return input->android_hardware_buffer_handle;
  }
