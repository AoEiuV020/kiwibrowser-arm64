  ...
  mojo::ScopedMessagePipeHandle TakeTrackingPipe() {
    ...
    bool ret =
        mojo::internal::Deserialize<mojo::ScopedMessagePipeHandle>(
            &data_->tracking_pipe, &result, context_);
    DCHECK(ret);
    return result;
  }
 private:
...
class GpuMemoryBufferHandleDataView {
 public:
  ...
  inline void GetAndroidHardwareBufferHandleDataView(
      AHardwareBufferHandleDataView* output);

  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadAndroidHardwareBufferHandle(UserType* output) {
    auto* pointer = data_->android_hardware_buffer_handle.Get();
...
struct Serializer<::gfx::mojom::AHardwareBufferHandleDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
                        Buffer* buffer,
                        ::gfx::mojom::internal::AHardwareBufferHandle_Data::BufferWriter* output,
                        SerializationContext* context) {
    if (CallIsNullIfExists<Traits>(input))
      return;
    void* custom_context = CustomContextHelper<Traits>::SetUp(input, context);
    ...
    decltype(CallWithContext(Traits::tracking_pipe, input, custom_context)) in_tracking_pipe = CallWithContext(Traits::tracking_pipe, input, custom_context);
    mojo::internal::Serialize<mojo::ScopedMessagePipeHandle>(
        in_tracking_pipe, &(*output)->tracking_pipe, context);
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        !mojo::internal::IsHandleOrInterfaceValid((*output)->tracking_pipe),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
  ...
  static bool Deserialize(::gfx::mojom::internal::AHardwareBufferHandle_Data* input,
    ...
    ::gfx::mojom::AHardwareBufferHandleDataView data_view(input, context);
    return Traits::Read(data_view, output);
  }
};
...
struct Serializer<::gfx::mojom::GpuMemoryBufferHandleDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    decltype(CallWithContext(Traits::android_hardware_buffer_handle, input, custom_context)) in_android_hardware_buffer_handle = CallWithContext(Traits::android_hardware_buffer_handle, input, custom_context);
    typename decltype((*output)->android_hardware_buffer_handle)::BaseType::BufferWriter
        android_hardware_buffer_handle_writer;
    mojo::internal::Serialize<::gfx::mojom::AHardwareBufferHandleDataView>(
        in_android_hardware_buffer_handle, buffer, &android_hardware_buffer_handle_writer, context);
    (*output)->android_hardware_buffer_handle.Set(
        android_hardware_buffer_handle_writer.is_null() ? nullptr : android_hardware_buffer_handle_writer.data());
    CustomContextHelper<Traits>::TearDown(input, custom_context);
  }
...
inline void GpuMemoryBufferHandleDataView::GetAndroidHardwareBufferHandleDataView(
    AHardwareBufferHandleDataView* output) {
  auto pointer = data_->android_hardware_buffer_handle.Get();
  *output = AHardwareBufferHandleDataView(pointer, context_);
}
