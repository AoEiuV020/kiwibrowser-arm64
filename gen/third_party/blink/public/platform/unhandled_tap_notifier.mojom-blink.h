...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_UNHANDLED_TAP_NOTIFIER_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_UNHANDLED_TAP_NOTIFIER_MOJOM_BLINK_H_
...
using RevocableUnhandledTapNotifierPtr = ::blink::RevocableInterfacePtr<UnhandledTapNotifier>;
...
class BLINK_PLATFORM_EXPORT UnhandledTapNotifier
...
class BLINK_PLATFORM_EXPORT UnhandledTapNotifierInterceptorForTesting : public UnhandledTapNotifier {
...
class BLINK_PLATFORM_EXPORT UnhandledTapNotifierAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT UnhandledTapNotifierProxy
...
class BLINK_PLATFORM_EXPORT UnhandledTapNotifierStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT UnhandledTapNotifierRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT UnhandledTapInfo {
 public:
  ...
  UnhandledTapInfo(
      const ::blink::WebPoint& tapped_position_in_viewport,
  ...
  ::blink::WebPoint tapped_position_in_viewport;
  uint32_t font_size_in_pixels;
  uint32_t element_text_run_length;
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::UnhandledTapInfo::DataView,
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_UNHANDLED_TAP_NOTIFIER_MOJOM_BLINK_H_