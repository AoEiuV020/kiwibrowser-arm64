...
constexpr uint32_t kKeyboardLockService_RequestKeyboardLock_Name = 0;
constexpr uint32_t kKeyboardLockService_CancelKeyboardLock_Name = 1;
constexpr uint32_t kKeyboardLockService_GetKeyboardLayoutMap_Name = 2;
