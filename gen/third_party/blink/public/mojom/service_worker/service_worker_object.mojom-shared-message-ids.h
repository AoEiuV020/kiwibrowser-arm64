...
constexpr uint32_t kServiceWorkerObjectHost_PostMessageToServiceWorker_Name = 0;
constexpr uint32_t kServiceWorkerObjectHost_TerminateForTesting_Name = 1;
constexpr uint32_t kServiceWorkerObject_StateChanged_Name = 0;
