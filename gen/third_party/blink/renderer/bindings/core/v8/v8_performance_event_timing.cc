...
void V8PerformanceEventTiming::processingEndAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  PerformanceEventTimingV8Internal::processingEndAttributeGetter(info);
}
...
static const V8DOMConfiguration::AccessorConfiguration V8PerformanceEventTimingAccessors[] = {
    ...
    { "processingEnd", V8PerformanceEventTiming::processingEndAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
