...
static void setAccessibilityNightModeFactorMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettings", "setAccessibilityNightModeFactor");
  ...
  nightModeFactor = NativeValueTraits<IDLFloat>::NativeValue(info.GetIsolate(), info[0], exceptionState);
  if (exceptionState.HadException())
    return;

  impl->setAccessibilityNightModeFactor(nightModeFactor, exceptionState);
  if (exceptionState.HadException()) {
    return;
  }
}
...
static void setAccessibilityNightModeEnabledMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettings", "setAccessibilityNightModeEnabled");
  ...
  bool nightModeFactor;
  nightModeFactor = NativeValueTraits<IDLBoolean>::NativeValue(info.GetIsolate(), info[0], exceptionState);
  if (exceptionState.HadException())
    return;

  impl->setAccessibilityNightModeEnabled(nightModeFactor, exceptionState);
  if (exceptionState.HadException()) {
    return;
  }
}
...
static void setAccessibilityNightModeGrayscaleEnabledMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettings", "setAccessibilityNightModeGrayscaleEnabled");
  ...
  impl->setAccessibilityNightModeGrayscaleEnabled(nightModeFactor, exceptionState);
  if (exceptionState.HadException()) {
    return;
  }
}
...
void V8InternalSettings::setAccessibilityNightModeFactorMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettings_setAccessibilityNightModeFactor");

  InternalSettingsV8Internal::setAccessibilityNightModeFactorMethod(info);
}

void V8InternalSettings::setAccessibilityNightModeEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettings_setAccessibilityNightModeEnabled");

  InternalSettingsV8Internal::setAccessibilityNightModeEnabledMethod(info);
}

void V8InternalSettings::setAccessibilityNightModeGrayscaleEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettings_setAccessibilityNightModeGrayscaleEnabled");

  InternalSettingsV8Internal::setAccessibilityNightModeGrayscaleEnabledMethod(info);
}
...
static const V8DOMConfiguration::MethodConfiguration V8InternalSettingsMethods[] = {
    ...
    {"setAccessibilityNightModeFactor", V8InternalSettings::setAccessibilityNightModeFactorMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    {"setAccessibilityNightModeEnabled", V8InternalSettings::setAccessibilityNightModeEnabledMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    {"setAccessibilityNightModeGrayscaleEnabled", V8InternalSettings::setAccessibilityNightModeGrayscaleEnabledMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
