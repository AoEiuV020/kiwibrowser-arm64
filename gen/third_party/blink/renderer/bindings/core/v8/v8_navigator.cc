...
void V8Navigator::CookiesOKAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Navigator_CookiesOK_Getter");

  NavigatorV8Internal::CookiesOKAttributeGetter(info);
}
...
static const V8DOMConfiguration::AccessorConfiguration V8NavigatorAccessors[] = {
    ...
    { "CookiesOK", V8Navigator::CookiesOKAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
