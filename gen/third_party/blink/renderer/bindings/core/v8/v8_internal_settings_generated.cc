...
static void setAccessibilityNightModeEnabledMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettingsGenerated", "setAccessibilityNightModeEnabled");
  ...
  bool accessibilityNightModeEnabled;
  accessibilityNightModeEnabled = NativeValueTraits<IDLBoolean>::NativeValue(info.GetIsolate(), info[0], exceptionState);
  if (exceptionState.HadException())
    return;

  impl->setAccessibilityNightModeEnabled(accessibilityNightModeEnabled);
}

static void setAccessibilityNightModeFactorMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettingsGenerated", "setAccessibilityNightModeFactor");
  ...
  double accessibilityNightModeFactor;
  accessibilityNightModeFactor = NativeValueTraits<IDLDouble>::NativeValue(info.GetIsolate(), info[0], exceptionState);
  if (exceptionState.HadException())
    return;

  impl->setAccessibilityNightModeFactor(accessibilityNightModeFactor);
}

static void setAccessibilityNightModeGrayscaleEnabledMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::kExecutionContext, "InternalSettingsGenerated", "setAccessibilityNightModeGrayscaleEnabled");
  ...
  bool accessibilityNightModeGrayscaleEnabled;
  accessibilityNightModeGrayscaleEnabled = NativeValueTraits<IDLBoolean>::NativeValue(info.GetIsolate(), info[0], exceptionState);
  if (exceptionState.HadException())
    return;

  impl->setAccessibilityNightModeGrayscaleEnabled(accessibilityNightModeGrayscaleEnabled);
}
...
void V8InternalSettingsGenerated::setAccessibilityNightModeEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettingsGenerated_setAccessibilityNightModeEnabled");

  InternalSettingsGeneratedV8Internal::setAccessibilityNightModeEnabledMethod(info);
}

void V8InternalSettingsGenerated::setAccessibilityNightModeFactorMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettingsGenerated_setAccessibilityNightModeFactor");

  InternalSettingsGeneratedV8Internal::setAccessibilityNightModeFactorMethod(info);
}

void V8InternalSettingsGenerated::setAccessibilityNightModeGrayscaleEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_InternalSettingsGenerated_setAccessibilityNightModeGrayscaleEnabled");

  InternalSettingsGeneratedV8Internal::setAccessibilityNightModeGrayscaleEnabledMethod(info);
}
...
static const V8DOMConfiguration::MethodConfiguration V8InternalSettingsGeneratedMethods[] = {
    ...
    {"setAccessibilityNightModeEnabled", V8InternalSettingsGenerated::setAccessibilityNightModeEnabledMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    {"setAccessibilityNightModeFactor", V8InternalSettingsGenerated::setAccessibilityNightModeFactorMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
    {"setAccessibilityNightModeGrayscaleEnabled", V8InternalSettingsGenerated::setAccessibilityNightModeGrayscaleEnabledMethodCallback, 1, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds},
