...
class V8InternalSettings {
 ...
 public:
  ...
  static void setAccessibilityNightModeFactorMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void setAccessibilityNightModeEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  static void setAccessibilityNightModeGrayscaleEnabledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
