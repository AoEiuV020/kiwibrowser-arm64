...
void V8Performance::installEventTiming(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface) {
  v8::Local<v8::FunctionTemplate> interfaceTemplate = V8Performance::wrapperTypeInfo.domTemplate(isolate, world);
  v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interfaceTemplate);
  ALLOW_UNUSED_LOCAL(signature);
  static const V8DOMConfiguration::AccessorConfiguration accessoroneventtimingbufferfullConfiguration[] = {
  ...
  for (const auto& accessorConfig : accessoroneventtimingbufferfullConfiguration)
    V8DOMConfiguration::InstallAccessor(isolate, world, instance, prototype, interface, signature, accessorConfig);
  static const V8DOMConfiguration::MethodConfiguration methodCleareventtimingsConfiguration[] = {
  ...
  for (const auto& methodConfig : methodCleareventtimingsConfiguration)
    V8DOMConfiguration::InstallMethod(isolate, world, instance, prototype, interface, signature, methodConfig);
  static const V8DOMConfiguration::MethodConfiguration methodSeteventtimingbuffermaxsizeConfiguration[] = {
  ...
  for (const auto& methodConfig : methodSeteventtimingbuffermaxsizeConfiguration)
    V8DOMConfiguration::InstallMethod(isolate, world, instance, prototype, interface, signature, methodConfig);
}

void V8Performance::installEventTiming(ScriptState* scriptState, v8::Local<v8::Object> instance) {
  V8PerContextData* perContextData = scriptState->PerContextData();
  v8::Local<v8::Object> prototype = perContextData->PrototypeForType(&V8Performance::wrapperTypeInfo);
  v8::Local<v8::Function> interface = perContextData->ConstructorForType(&V8Performance::wrapperTypeInfo);
  ALLOW_UNUSED_LOCAL(interface);
  installEventTiming(scriptState->GetIsolate(), scriptState->World(), instance, prototype, interface);
}

void V8Performance::installEventTiming(ScriptState* scriptState) {
  installEventTiming(scriptState, v8::Local<v8::Object>());
}
