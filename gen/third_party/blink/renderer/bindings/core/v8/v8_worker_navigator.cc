...
static void CookiesOKAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  v8::Local<v8::Object> holder = info.Holder();

  WorkerNavigator* impl = V8WorkerNavigator::ToImpl(holder);

  V8SetReturnValueString(info, impl->cookiesOK(), info.GetIsolate());
}
...
void V8WorkerNavigator::CookiesOKAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WorkerNavigator_CookiesOK_Getter");

  WorkerNavigatorV8Internal::CookiesOKAttributeGetter(info);
}
...
static const V8DOMConfiguration::AccessorConfiguration V8WorkerNavigatorAccessors[] = {
    ...
    { "CookiesOK", V8WorkerNavigator::CookiesOKAttributeGetterCallback, nullptr, V8PrivateProperty::kNoCachedAccessor, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kHasSideEffect, V8DOMConfiguration::kAllWorlds },
