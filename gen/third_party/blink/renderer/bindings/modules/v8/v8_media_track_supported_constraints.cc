...
void V8MediaTrackSupportedConstraints::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, MediaTrackSupportedConstraints& impl, ExceptionState& exceptionState) {
  ...
  if (!v8Object->Get(context, keys[23].Get(isolate)).ToLocal(&pointsOfInterestValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[24].Get(isolate)).ToLocal(&sampleRateValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[25].Get(isolate)).ToLocal(&sampleSizeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[26].Get(isolate)).ToLocal(&saturationValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[27].Get(isolate)).ToLocal(&sharpnessValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[28].Get(isolate)).ToLocal(&torchValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[30].Get(isolate)).ToLocal(&volumeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[31].Get(isolate)).ToLocal(&whiteBalanceModeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[32].Get(isolate)).ToLocal(&widthValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[33].Get(isolate)).ToLocal(&zoomValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (!v8Object->Get(context, keys[29].Get(isolate)).ToLocal(&videoKindValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (OriginTrials::experimentalHardwareEchoCancellationEnabled(executionContext)) {
    ...
    if (echoCancellationTypeValue.IsEmpty() || echoCancellationTypeValue->IsUndefined()) {
      ...
      bool echoCancellationTypeCppValue = NativeValueTraits<IDLBoolean>::NativeValue(isolate, echoCancellationTypeValue, exceptionState);
      if (exceptionState.HadException())
        return;
...
bool toV8MediaTrackSupportedConstraints(const MediaTrackSupportedConstraints& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (pointsOfInterestHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[23].Get(isolate), pointsOfInterestValue))) {
    return false;
  }
  ...
  if (sampleRateHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[24].Get(isolate), sampleRateValue))) {
    return false;
  }
  ...
  if (sampleSizeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[25].Get(isolate), sampleSizeValue))) {
    return false;
  }
  ...
  if (saturationHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[26].Get(isolate), saturationValue))) {
    return false;
  }
  ...
  if (sharpnessHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[27].Get(isolate), sharpnessValue))) {
    return false;
  }
  ...
  if (torchHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[28].Get(isolate), torchValue))) {
    return false;
  }
  ...
  if (volumeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[30].Get(isolate), volumeValue))) {
    return false;
  }
  ...
  if (whiteBalanceModeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[31].Get(isolate), whiteBalanceModeValue))) {
    return false;
  }
  ...
  if (widthHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[32].Get(isolate), widthValue))) {
    return false;
  }
  ...
  if (zoomHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[33].Get(isolate), zoomValue))) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (videoKindHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[29].Get(isolate), videoKindValue))) {
      return false;
    }
  }
  ...
  if (OriginTrials::experimentalHardwareEchoCancellationEnabled(executionContext)) {
    ...
    if (impl.hasEchoCancellationType()) {
      echoCancellationTypeValue = v8::Boolean::New(isolate, impl.echoCancellationType());
      echoCancellationTypeHasValueOrDefault = true;
    } else {
      echoCancellationTypeValue = v8::Boolean::New(isolate, true);
      echoCancellationTypeHasValueOrDefault = true;
    }
