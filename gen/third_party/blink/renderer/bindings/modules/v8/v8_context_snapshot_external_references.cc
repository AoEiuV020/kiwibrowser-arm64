...
const intptr_t* V8ContextSnapshotExternalReferences::GetTable() {
  static const intptr_t reference_table[] = {
    ...
    reinterpret_cast<intptr_t>(V8Window::adblockAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::adblockAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Window::adblock2AttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::adblock2AttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Window::smrtAdSySPopAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::smrtAdSySPopAttributeSetterCallback),
    reinterpret_cast<intptr_t>(V8Window::sadblAttributeGetterCallback),
    reinterpret_cast<intptr_t>(V8Window::sadblAttributeSetterCallback),
