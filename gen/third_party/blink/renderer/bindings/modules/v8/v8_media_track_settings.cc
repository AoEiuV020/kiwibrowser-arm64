...
void V8MediaTrackSettings::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, MediaTrackSettings& impl, ExceptionState& exceptionState) {
  ...
  if (!v8Object->Get(context, keys[20].Get(isolate)).ToLocal(&noiseSuppressionValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[21].Get(isolate)).ToLocal(&pointsOfInterestValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[22].Get(isolate)).ToLocal(&saturationValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[23].Get(isolate)).ToLocal(&sharpnessValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[24].Get(isolate)).ToLocal(&torchValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[26].Get(isolate)).ToLocal(&whiteBalanceModeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[27].Get(isolate)).ToLocal(&widthValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[28].Get(isolate)).ToLocal(&zoomValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (!v8Object->Get(context, keys[25].Get(isolate)).ToLocal(&videoKindValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (OriginTrials::experimentalHardwareEchoCancellationEnabled(executionContext)) {
    ...
    if (!v8Object->Get(context, keys[9].Get(isolate)).ToLocal(&echoCancellationTypeValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
    if (echoCancellationTypeValue.IsEmpty() || echoCancellationTypeValue->IsUndefined()) {
      ...
      V8StringResource<> echoCancellationTypeCppValue = echoCancellationTypeValue;
      if (!echoCancellationTypeCppValue.Prepare(exceptionState))
        return;
...
bool toV8MediaTrackSettings(const MediaTrackSettings& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (noiseSuppressionHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[20].Get(isolate), noiseSuppressionValue))) {
    return false;
  }
  ...
  if (pointsOfInterestHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[21].Get(isolate), pointsOfInterestValue))) {
    return false;
  }
  ...
  if (saturationHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[22].Get(isolate), saturationValue))) {
    return false;
  }
  ...
  if (sharpnessHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[23].Get(isolate), sharpnessValue))) {
    return false;
  }
  ...
  if (torchHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[24].Get(isolate), torchValue))) {
    return false;
  }
  ...
  if (whiteBalanceModeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[26].Get(isolate), whiteBalanceModeValue))) {
    return false;
  }
  ...
  if (widthHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[27].Get(isolate), widthValue))) {
    return false;
  }
  ...
  if (zoomHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[28].Get(isolate), zoomValue))) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (videoKindHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[25].Get(isolate), videoKindValue))) {
      return false;
    }
  }
  ...
  if (OriginTrials::experimentalHardwareEchoCancellationEnabled(executionContext)) {
    ...
    if (impl.hasEchoCancellationType()) {
      echoCancellationTypeValue = V8String(isolate, impl.echoCancellationType());
      echoCancellationTypeHasValueOrDefault = true;
    }
    if (echoCancellationTypeHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[9].Get(isolate), echoCancellationTypeValue))) {
      return false;
    }
  }
