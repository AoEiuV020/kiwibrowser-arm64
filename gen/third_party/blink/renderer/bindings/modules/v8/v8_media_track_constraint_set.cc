...
void V8MediaTrackConstraintSet::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, MediaTrackConstraintSet& impl, ExceptionState& exceptionState) {
  ...
  if (!v8Object->Get(context, keys[11].Get(isolate)).ToLocal(&exposureCompensationValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[12].Get(isolate)).ToLocal(&exposureModeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[13].Get(isolate)).ToLocal(&facingModeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[16].Get(isolate)).ToLocal(&focusModeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[17].Get(isolate)).ToLocal(&frameRateValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[18].Get(isolate)).ToLocal(&groupIdValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[19].Get(isolate)).ToLocal(&heightValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[20].Get(isolate)).ToLocal(&isoValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[21].Get(isolate)).ToLocal(&latencyValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[22].Get(isolate)).ToLocal(&mandatoryValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[23].Get(isolate)).ToLocal(&noiseSuppressionValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[24].Get(isolate)).ToLocal(&optionalValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[25].Get(isolate)).ToLocal(&pointsOfInterestValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[26].Get(isolate)).ToLocal(&sampleRateValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[27].Get(isolate)).ToLocal(&sampleSizeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[28].Get(isolate)).ToLocal(&saturationValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[29].Get(isolate)).ToLocal(&sharpnessValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[30].Get(isolate)).ToLocal(&torchValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[32].Get(isolate)).ToLocal(&volumeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[33].Get(isolate)).ToLocal(&whiteBalanceModeValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[34].Get(isolate)).ToLocal(&widthValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[35].Get(isolate)).ToLocal(&zoomValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthEnabled()) {
    ...
    if (!v8Object->Get(context, keys[14].Get(isolate)).ToLocal(&focalLengthXValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
    ...
    if (!v8Object->Get(context, keys[15].Get(isolate)).ToLocal(&focalLengthYValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (!v8Object->Get(context, keys[31].Get(isolate)).ToLocal(&videoKindValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (OriginTrials::experimentalHardwareEchoCancellationEnabled(executionContext)) {
    v8::Local<v8::Value> echoCancellationTypeValue;
    if (!v8Object->Get(context, keys[10].Get(isolate)).ToLocal(&echoCancellationTypeValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
    if (echoCancellationTypeValue.IsEmpty() || echoCancellationTypeValue->IsUndefined()) {
      // Do nothing.
    } else {
      StringOrStringSequenceOrConstrainDOMStringParameters echoCancellationTypeCppValue;
      V8StringOrStringSequenceOrConstrainDOMStringParameters::ToImpl(isolate, echoCancellationTypeValue, echoCancellationTypeCppValue, UnionTypeConversionMode::kNotNullable, exceptionState);
      if (exceptionState.HadException())
        return;
      impl.setEchoCancellationType(echoCancellationTypeCppValue);
    }
  }
}
...
bool toV8MediaTrackConstraintSet(const MediaTrackConstraintSet& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (exposureCompensationHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[11].Get(isolate), exposureCompensationValue))) {
    return false;
  }
  ...
  if (exposureModeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[12].Get(isolate), exposureModeValue))) {
    return false;
  }
  ...
  if (facingModeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[13].Get(isolate), facingModeValue))) {
    return false;
  }
  ...
  if (focusModeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[16].Get(isolate), focusModeValue))) {
    return false;
  }
  ...
  if (frameRateHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[17].Get(isolate), frameRateValue))) {
    return false;
  }
  ...
  if (groupIdHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[18].Get(isolate), groupIdValue))) {
    return false;
  }
  ...
  if (heightHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[19].Get(isolate), heightValue))) {
    return false;
  }
  ...
  if (isoHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[20].Get(isolate), isoValue))) {
    return false;
  }
  ...
  if (latencyHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[21].Get(isolate), latencyValue))) {
    return false;
  }
  ...
  if (mandatoryHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[22].Get(isolate), mandatoryValue))) {
    return false;
  }
  ...
  if (noiseSuppressionHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[23].Get(isolate), noiseSuppressionValue))) {
    return false;
  }
  ...
  if (optionalHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[24].Get(isolate), optionalValue))) {
    return false;
  }
  ...
  if (pointsOfInterestHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[25].Get(isolate), pointsOfInterestValue))) {
    return false;
  }
  ...
  if (sampleRateHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[26].Get(isolate), sampleRateValue))) {
    return false;
  }
  ...
  if (sampleSizeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[27].Get(isolate), sampleSizeValue))) {
    return false;
  }
  ...
  if (saturationHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[28].Get(isolate), saturationValue))) {
    return false;
  }
  ...
  if (sharpnessHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[29].Get(isolate), sharpnessValue))) {
    return false;
  }
  ...
  if (torchHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[30].Get(isolate), torchValue))) {
    return false;
  }
  ...
  if (volumeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[32].Get(isolate), volumeValue))) {
    return false;
  }
  ...
  if (whiteBalanceModeHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[33].Get(isolate), whiteBalanceModeValue))) {
    return false;
  }
  ...
  if (widthHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[34].Get(isolate), widthValue))) {
    return false;
  }
  ...
  if (zoomHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[35].Get(isolate), zoomValue))) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthEnabled()) {
    ...
    if (focalLengthXHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[14].Get(isolate), focalLengthXValue))) {
      return false;
    }
    ...
    if (focalLengthYHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[15].Get(isolate), focalLengthYValue))) {
      return false;
    }
  }
  ...
  if (RuntimeEnabledFeatures::MediaCaptureDepthVideoKindEnabled()) {
    ...
    if (videoKindHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[31].Get(isolate), videoKindValue))) {
      return false;
    }
  }
  ...
  if (OriginTrials::experimentalHardwareEchoCancellationEnabled(executionContext)) {
    v8::Local<v8::Value> echoCancellationTypeValue;
    bool echoCancellationTypeHasValueOrDefault = false;
    if (impl.hasEchoCancellationType()) {
      echoCancellationTypeValue = ToV8(impl.echoCancellationType(), creationContext, isolate);
      echoCancellationTypeHasValueOrDefault = true;
    }
    if (echoCancellationTypeHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[10].Get(isolate), echoCancellationTypeValue))) {
      return false;
    }
  }
