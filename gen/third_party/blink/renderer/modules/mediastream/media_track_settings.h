...
class MODULES_EXPORT MediaTrackSettings : public IDLDictionaryBase {
 ...
 public:
  ...
  const String& echoCancellationType() const {
    return echo_cancellation_type_;
  }
  inline void setEchoCancellationType(const String&);
 ...
 private:
  ...
  String echo_cancellation_type_;
...
void MediaTrackSettings::setEchoCancellationType(const String& value) {
