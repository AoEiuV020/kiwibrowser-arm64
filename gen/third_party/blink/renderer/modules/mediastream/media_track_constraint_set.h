...
class MODULES_EXPORT MediaTrackConstraintSet : public IDLDictionaryBase {
 ...
 public:
  ...
  bool hasDepthFar() const { return !depth_far_.IsNull(); }
  const DoubleOrConstrainDoubleRange& depthFar() const {
    return depth_far_;
  }
  void setDepthFar(const DoubleOrConstrainDoubleRange&);

  bool hasDepthNear() const { return !depth_near_.IsNull(); }
  const DoubleOrConstrainDoubleRange& depthNear() const {
    return depth_near_;
  }
  void setDepthNear(const DoubleOrConstrainDoubleRange&);
  ...
  bool hasEchoCancellationType() const { return !echo_cancellation_type_.IsNull(); }
  const StringOrStringSequenceOrConstrainDOMStringParameters& echoCancellationType() const {
    return echo_cancellation_type_;
  }
  void setEchoCancellationType(const StringOrStringSequenceOrConstrainDOMStringParameters&);
  ...
  bool hasFocalLengthX() const { return !focal_length_x_.IsNull(); }
  const DoubleOrConstrainDoubleRange& focalLengthX() const {
    return focal_length_x_;
  }
  void setFocalLengthX(const DoubleOrConstrainDoubleRange&);

  bool hasFocalLengthY() const { return !focal_length_y_.IsNull(); }
  const DoubleOrConstrainDoubleRange& focalLengthY() const {
    return focal_length_y_;
  }
  void setFocalLengthY(const DoubleOrConstrainDoubleRange&);
 ...
 private:
  ...
  DoubleOrConstrainDoubleRange depth_far_;
  DoubleOrConstrainDoubleRange depth_near_;
  StringOrStringSequenceOrConstrainDOMStringParameters device_id_;
  BooleanOrConstrainBooleanParameters echo_cancellation_;
  StringOrStringSequenceOrConstrainDOMStringParameters echo_cancellation_type_;
  ...
  DoubleOrConstrainDoubleRange focal_length_x_;
  DoubleOrConstrainDoubleRange focal_length_y_;
