...
class MODULES_EXPORT MediaTrackSupportedConstraints : public IDLDictionaryBase {
 ...
 public:
  ...
  inline void setDepthFar(bool);

  bool hasDepthNear() const { return has_depth_near_; }
  bool depthNear() const {
    DCHECK(has_depth_near_);
    return depth_near_;
  }
  inline void setDepthNear(bool);
  ...
  bool hasEchoCancellationType() const { return has_echo_cancellation_type_; }
  bool echoCancellationType() const {
    DCHECK(has_echo_cancellation_type_);
    return echo_cancellation_type_;
  }
  inline void setEchoCancellationType(bool);
 ...
 private:
  ...
  bool has_echo_cancellation_type_ = false;
  ...
  bool echo_cancellation_type_;
  bool exposure_compensation_;
  bool exposure_mode_;
  bool facing_mode_;
  bool focal_length_x_;
  bool focal_length_y_;
  bool focus_mode_;
  bool frame_rate_;
  bool group_id_;
  bool height_;
...
void MediaTrackSupportedConstraints::setDepthFar(bool value) {
  depth_far_ = value;
  has_depth_far_ = true;
}

void MediaTrackSupportedConstraints::setDepthNear(bool value) {
  depth_near_ = value;
...
void MediaTrackSupportedConstraints::setEchoCancellationType(bool value) {
  echo_cancellation_type_ = value;
  has_echo_cancellation_type_ = true;
}
...
void MediaTrackSupportedConstraints::setFocalLengthX(bool value) {
  focal_length_x_ = value;
  has_focal_length_x_ = true;
}

void MediaTrackSupportedConstraints::setFocalLengthY(bool value) {
