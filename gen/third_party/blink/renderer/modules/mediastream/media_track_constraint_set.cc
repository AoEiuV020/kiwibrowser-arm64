...
void MediaTrackConstraintSet::setDepthFar(const DoubleOrConstrainDoubleRange& value) {
  depth_far_ = value;
}

void MediaTrackConstraintSet::setDepthNear(const DoubleOrConstrainDoubleRange& value) {
  depth_near_ = value;
}
...
void MediaTrackConstraintSet::setEchoCancellationType(const StringOrStringSequenceOrConstrainDOMStringParameters& value) {
...
void MediaTrackConstraintSet::setFocalLengthX(const DoubleOrConstrainDoubleRange& value) {
  focal_length_x_ = value;
}

void MediaTrackConstraintSet::setFocalLengthY(const DoubleOrConstrainDoubleRange& value) {
