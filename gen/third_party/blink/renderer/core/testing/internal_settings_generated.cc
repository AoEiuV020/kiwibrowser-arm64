...
InternalSettingsGenerated::InternalSettingsGenerated(Page* page)
    ...
    , m_accessibilityNightModeEnabled(page->GetSettings().GetAccessibilityNightModeEnabled())
    , m_accessibilityNightModeFactor(page->GetSettings().GetAccessibilityNightModeFactor())
    , m_accessibilityNightModeGrayscaleEnabled(page->GetSettings().GetAccessibilityNightModeGrayscaleEnabled())
...
void InternalSettingsGenerated::resetToConsistentState() {
  ...
  m_page->GetSettings().SetAccessibilityNightModeEnabled(m_accessibilityNightModeEnabled);
  m_page->GetSettings().SetAccessibilityNightModeFactor(m_accessibilityNightModeFactor);
  m_page->GetSettings().SetAccessibilityNightModeGrayscaleEnabled(m_accessibilityNightModeGrayscaleEnabled);
...
void InternalSettingsGenerated::setAccessibilityNightModeEnabled(bool accessibilityNightModeEnabled) {
  m_page->GetSettings().SetAccessibilityNightModeEnabled(accessibilityNightModeEnabled);
}

void InternalSettingsGenerated::setAccessibilityNightModeFactor(double accessibilityNightModeFactor) {
  m_page->GetSettings().SetAccessibilityNightModeFactor(accessibilityNightModeFactor);
}

void InternalSettingsGenerated::setAccessibilityNightModeGrayscaleEnabled(bool accessibilityNightModeGrayscaleEnabled) {
  m_page->GetSettings().SetAccessibilityNightModeGrayscaleEnabled(accessibilityNightModeGrayscaleEnabled);
}
