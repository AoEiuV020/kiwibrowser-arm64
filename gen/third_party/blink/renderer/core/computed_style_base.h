...
//   templates/computed_style_base.h.tmpl
// and input files:
...
class ComputedStyleBase {
 public:
  ...
  bool ForceLegacyLayout() const {
    return static_cast<bool>(rare_inherited_usage_less_than_40_percent_data_->rare_inherited_usage_less_than_40_percent_sub_data_->force_legacy_layout_);
  }

  void SetForceLegacyLayout(bool v) {
    if (!(rare_inherited_usage_less_than_40_percent_data_->rare_inherited_usage_less_than_40_percent_sub_data_->force_legacy_layout_ == static_cast<unsigned>(v)))
      rare_inherited_usage_less_than_40_percent_data_.Access()->rare_inherited_usage_less_than_40_percent_sub_data_.Access()->force_legacy_layout_ = static_cast<unsigned>(v);
  }

  inline void ResetForceLegacyLayout() {
    rare_inherited_usage_less_than_40_percent_data_.Access()->rare_inherited_usage_less_than_40_percent_sub_data_.Access()->force_legacy_layout_ = static_cast<unsigned>(false);
  }
  ...
  ScrollCustomization::ScrollDirection ScrollCustomization() const {
    return static_cast<ScrollCustomization::ScrollDirection>(rare_non_inherited_usage_less_than_13_percent_data_->rare_non_inherited_usage_less_than_13_percent_sub_data_->scroll_customization_);
  }

  void SetScrollCustomization(ScrollCustomization::ScrollDirection v) {
  ...
  inline void ResetScrollCustomization() {
    rare_non_inherited_usage_less_than_13_percent_data_.Access()->rare_non_inherited_usage_less_than_13_percent_sub_data_.Access()->scroll_customization_ = static_cast<unsigned>(ScrollCustomization::kScrollDirectionNone);
  }
 ...
 private:
  ...
  class StyleRareNonInheritedUsageLessThan13PercentSubData : public RefCounted<StyleRareNonInheritedUsageLessThan13PercentSubData> {
   public:
    ...
    unsigned scroll_customization_ : 4; // ScrollCustomization::ScrollDirection
   ...
   public:
    ...
    bool operator==(const StyleRareInheritedUsageLessThan40PercentSubData& other) const {
      return (
        ...
        && force_legacy_layout_ == other.force_legacy_layout_
    ...
    unsigned force_legacy_layout_ : 1; // bool
 ...
 protected:
  ...
  bool MutableForceLegacyLayoutInternal() {
    return static_cast<bool>(rare_inherited_usage_less_than_40_percent_data_.Access()->rare_inherited_usage_less_than_40_percent_sub_data_.Access()->force_legacy_layout_);
  }
  ...
  ScrollCustomization::ScrollDirection MutableScrollCustomizationInternal() {
    return static_cast<ScrollCustomization::ScrollDirection>(rare_non_inherited_usage_less_than_13_percent_data_.Access()->rare_non_inherited_usage_less_than_13_percent_sub_data_.Access()->scroll_customization_);
  }
