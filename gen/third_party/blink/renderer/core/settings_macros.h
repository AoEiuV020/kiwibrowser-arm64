...
#define SETTINGS_GETTERS_AND_SETTERS \
    ...
    bool GetAccessibilityNightModeEnabled() const { return accessibilityNightModeEnabled_; } \
    void SetAccessibilityNightModeEnabled(bool accessibilityNightModeEnabled); \
    double GetAccessibilityNightModeFactor() const { return accessibilityNightModeFactor_; } \
    void SetAccessibilityNightModeFactor(double accessibilityNightModeFactor); \
    bool GetAccessibilityNightModeGrayscaleEnabled() const { return accessibilityNightModeGrayscaleEnabled_; } \
    void SetAccessibilityNightModeGrayscaleEnabled(bool accessibilityNightModeGrayscaleEnabled); \
...
#define SETTINGS_MEMBER_VARIABLES \
    ...
    double accessibilityNightModeFactor_; \
    ...
    bool accessibilityNightModeEnabled_ : 1; \
    bool accessibilityNightModeGrayscaleEnabled_ : 1; \
...
#define SETTINGS_INITIALIZER_LIST \
    ...
    , accessibilityNightModeFactor_(0.0) \
    ...
    , accessibilityNightModeEnabled_(false) \
    , accessibilityNightModeGrayscaleEnabled_(false) \
...
void Settings::SetAccessibilityNightModeEnabled(bool accessibilityNightModeEnabled) { \
  if (accessibilityNightModeEnabled_ == accessibilityNightModeEnabled) \
    return; \
  accessibilityNightModeEnabled_ = accessibilityNightModeEnabled; \
} \
void Settings::SetAccessibilityNightModeFactor(double accessibilityNightModeFactor) { \
  if (accessibilityNightModeFactor_ == accessibilityNightModeFactor) \
    return; \
  accessibilityNightModeFactor_ = accessibilityNightModeFactor; \
} \
void Settings::SetAccessibilityNightModeGrayscaleEnabled(bool accessibilityNightModeGrayscaleEnabled) { \
  if (accessibilityNightModeGrayscaleEnabled_ == accessibilityNightModeGrayscaleEnabled) \
    return; \
  accessibilityNightModeGrayscaleEnabled_ = accessibilityNightModeGrayscaleEnabled; \
} \
...
void Settings::SetFromStrings(const String& name, const String& value) { \
  ...
  if (name == "accessibilityNightModeEnabled") { \
    SetAccessibilityNightModeEnabled( \
      value.IsEmpty() || value == "true" \
    ); \
    return; \
  } \
  if (name == "accessibilityNightModeFactor") { \
    SetAccessibilityNightModeFactor( \
      value.ToDouble() \
    ); \
    return; \
  } \
  if (name == "accessibilityNightModeGrayscaleEnabled") { \
    SetAccessibilityNightModeGrayscaleEnabled( \
      value.IsEmpty() || value == "true" \
    ); \
    return; \
  } \
