  ...
  class BufferWriter {
   public:
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      ...
      index_ = serialization_buffer_->Allocate(sizeof(Message_Data));
      new (data()) Message_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    Message_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<Message_Data>(index_);
    }
    Message_Data* operator->() { return data(); }
...
static_assert(sizeof(Message_Data) == 32,
...
struct Message_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
    ...
    Message_Data::BufferWriter writer;
