...
class  AudioOutputStreamProvider
 ...
 public:
  ...
  virtual void Acquire(const media::AudioParameters& params, AudioOutputStreamProviderClientPtr client) = 0;
};
class  AudioOutputStreamProviderInterceptorForTesting : public AudioOutputStreamProvider {
  ...
  void Acquire(const media::AudioParameters& params, AudioOutputStreamProviderClientPtr client) override;
};
...
class  AudioOutputStreamProviderClient
 ...
 public:
  ...
  virtual void Created(AudioOutputStreamPtr stream, ::media::mojom::AudioDataPipePtr data_pipe) = 0;
};
class  AudioOutputStreamProviderClientInterceptorForTesting : public AudioOutputStreamProviderClient {
  ...
  void Created(AudioOutputStreamPtr stream, ::media::mojom::AudioDataPipePtr data_pipe) override;
};
...
class  AudioOutputStreamProviderProxy
 ...
 public:
  ...
  void Acquire(const media::AudioParameters& params, AudioOutputStreamProviderClientPtr client) final;
...
class  AudioOutputStreamProviderClientProxy
 ...
 public:
  ...
  void Created(AudioOutputStreamPtr stream, ::media::mojom::AudioDataPipePtr data_pipe) final;
