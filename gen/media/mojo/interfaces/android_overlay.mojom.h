...
#ifndef MEDIA_MOJO_INTERFACES_ANDROID_OVERLAY_MOJOM_H_
#define MEDIA_MOJO_INTERFACES_ANDROID_OVERLAY_MOJOM_H_
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AndroidOverlayConfig::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::media::mojom::AndroidOverlayConfig::DataView,
                                         ::media::mojom::AndroidOverlayConfigPtr> {
  static bool IsNull(const ::media::mojom::AndroidOverlayConfigPtr& input) { return !input; }
  static void SetToNull(::media::mojom::AndroidOverlayConfigPtr* output) { output->reset(); }

  static const decltype(::media::mojom::AndroidOverlayConfig::routing_token)& routing_token(
      const ::media::mojom::AndroidOverlayConfigPtr& input) {
    return input->routing_token;
  }

  static const decltype(::media::mojom::AndroidOverlayConfig::rect)& rect(
      const ::media::mojom::AndroidOverlayConfigPtr& input) {
    return input->rect;
  }

  static decltype(::media::mojom::AndroidOverlayConfig::secure) secure(
      const ::media::mojom::AndroidOverlayConfigPtr& input) {
    return input->secure;
  }

  static decltype(::media::mojom::AndroidOverlayConfig::power_efficient) power_efficient(
      const ::media::mojom::AndroidOverlayConfigPtr& input) {
    return input->power_efficient;
  }

  static bool Read(::media::mojom::AndroidOverlayConfig::DataView input, ::media::mojom::AndroidOverlayConfigPtr* output);
};

}  // namespace mojo

#endif  // MEDIA_MOJO_INTERFACES_ANDROID_OVERLAY_MOJOM_H_