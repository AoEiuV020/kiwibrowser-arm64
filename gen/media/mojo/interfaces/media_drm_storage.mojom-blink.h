...
#ifndef MEDIA_MOJO_INTERFACES_MEDIA_DRM_STORAGE_MOJOM_BLINK_H_
#define MEDIA_MOJO_INTERFACES_MEDIA_DRM_STORAGE_MOJOM_BLINK_H_
...
using RevocableMediaDrmStoragePtr = ::blink::RevocableInterfacePtr<MediaDrmStorage>;
...
class  MediaDrmStorage
 ...
 public:
  ...
  using InitializeCallback = base::OnceCallback<void(::mojo_base::mojom::blink::UnguessableTokenPtr)>;
...
class  SessionData {
 public:
  ...
  SessionData(
      const WTF::Vector<uint8_t>& key_set_id,
...
template <>
struct  StructTraits<::media::mojom::blink::SessionData::DataView,
...
#endif  // MEDIA_MOJO_INTERFACES_MEDIA_DRM_STORAGE_MOJOM_BLINK_H_