...
template <>
struct DefaultHash<::media::mojom::AudioOutputStreamObserver_DisconnectReason> {
  using Hash = media_mojom_internal_AudioOutputStreamObserver_DisconnectReason_DataHashFn;
};
