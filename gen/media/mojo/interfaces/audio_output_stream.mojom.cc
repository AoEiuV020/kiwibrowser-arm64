...
void AudioOutputStreamProviderProxy::Acquire(
    const media::AudioParameters& in_params, AudioOutputStreamProviderClientPtr in_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AudioOutputStreamProviderInterceptorForTesting::Acquire(const media::AudioParameters& params, AudioOutputStreamProviderClientPtr client) {
...
void AudioOutputStreamProviderClientProxy::Created(
    AudioOutputStreamPtr in_stream, ::media::mojom::AudioDataPipePtr in_data_pipe) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AudioOutputStreamProviderClientInterceptorForTesting::Created(AudioOutputStreamPtr stream, ::media::mojom::AudioDataPipePtr data_pipe) {
