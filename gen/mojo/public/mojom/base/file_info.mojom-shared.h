...
struct Serializer<::mojo_base::mojom::FileInfoDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    (*output)->is_directory = CallWithContext(Traits::is_directory, input, custom_context);
    (*output)->is_symbolic_link = CallWithContext(Traits::is_symbolic_link, input, custom_context);
    ...
    decltype(CallWithContext(Traits::last_accessed, input, custom_context)) in_last_accessed = CallWithContext(Traits::last_accessed, input, custom_context);
