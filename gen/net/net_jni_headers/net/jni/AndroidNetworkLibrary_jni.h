...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_clazz = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_getMimeTypeFromExtension =
    0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_haveOnlyLoopbackAddresses =
    0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_verifyServerCertificates =
    0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_addTestRootCertificate = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_clearTestRootCertificates =
    0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_getNetworkCountryIso = 0;
static base::android::ScopedJavaLocalRef<jstring>
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_getNetworkOperator = 0;
static base::android::ScopedJavaLocalRef<jstring>
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_getSimOperator = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_getIsRoaming = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_getIsCaptivePortal = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_getWifiSSID = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_isCleartextPermitted = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_getDnsServers = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_AndroidNetworkLibrary_tagSocket = 0;
static void Java_AndroidNetworkLibrary_tagSocket(JNIEnv* env, JniIntWrapper ifd,
  ...
  jmethodID method_id = base::android::MethodID::LazyGet<
     ...
     env->CallStaticVoidMethod(org_chromium_net_AndroidNetworkLibrary_clazz(env),
          method_id, as_jint(ifd), as_jint(uid), as_jint(tag));
  jni_generator::CheckException(env);
}
