...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_net_HttpNegotiateAuthenticator_clazz
    = 0;
...
JNI_GENERATOR_EXPORT void Java_org_chromium_net_HttpNegotiateAuthenticator_nativeSetResult(
    JNIEnv* env,
    jobject jcaller,
  ...
  return native->SetResult(env, base::android::JavaParamRef<jobject>(env, jcaller), status,
      base::android::JavaParamRef<jstring>(env, authToken));
}


static base::subtle::AtomicWord g_org_chromium_net_HttpNegotiateAuthenticator_create = 0;
...
static base::subtle::AtomicWord g_org_chromium_net_HttpNegotiateAuthenticator_getNextAuthToken = 0;
static void Java_HttpNegotiateAuthenticator_getNextAuthToken(JNIEnv* env, const
  ...
  jmethodID method_id = base::android::MethodID::LazyGet<
     ...
     env->CallVoidMethod(obj.obj(),
          method_id, nativeResultObject, principal.obj(), authToken.obj(), canDelegate);
  jni_generator::CheckException(env);
}
