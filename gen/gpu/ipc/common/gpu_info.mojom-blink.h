...
class  GpuInfo {
 public:
  ...
  GpuInfo(
      WTF::TimeDelta initialization_time,
      bool optimus,
      bool amd_switchable,
      GpuDevicePtr gpu,
...
bool GpuInfo::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->software_rendering, other_struct.software_rendering))
    return false;
  if (!mojo::Equals(this->direct_rendering, other_struct.direct_rendering))
    return false;
...
struct  StructTraits<::gpu::mojom::blink::GpuInfo::DataView,
  ...
  static decltype(::gpu::mojom::blink::GpuInfo::direct_composition) direct_composition(
      const ::gpu::mojom::blink::GpuInfoPtr& input) {
    return input->direct_composition;
  }

  static decltype(::gpu::mojom::blink::GpuInfo::supports_overlays) supports_overlays(
      const ::gpu::mojom::blink::GpuInfoPtr& input) {
