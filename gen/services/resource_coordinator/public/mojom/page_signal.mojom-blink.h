...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) PageSignalReceiver
 ...
 public:
  ...
  virtual void NotifyPageAlmostIdle(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id) = 0;

  virtual void SetExpectedTaskQueueingDuration(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id, WTF::TimeDelta duration) = 0;

  virtual void SetLifecycleState(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id, ::resource_coordinator::mojom::blink::LifecycleState state) = 0;

  virtual void NotifyNonPersistentNotificationCreated(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id) = 0;
};
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) PageSignalReceiverInterceptorForTesting : public PageSignalReceiver {
  ...
  void NotifyPageAlmostIdle(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id) override;
  void SetExpectedTaskQueueingDuration(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id, WTF::TimeDelta duration) override;
  void SetLifecycleState(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id, ::resource_coordinator::mojom::blink::LifecycleState state) override;
  void NotifyNonPersistentNotificationCreated(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id) override;
};
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_BLINK) PageSignalReceiverProxy
 ...
 public:
  ...
  void NotifyPageAlmostIdle(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id) final;
  void SetExpectedTaskQueueingDuration(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id, WTF::TimeDelta duration) final;
  void SetLifecycleState(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id, ::resource_coordinator::mojom::blink::LifecycleState state) final;
  void NotifyNonPersistentNotificationCreated(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id) final;
