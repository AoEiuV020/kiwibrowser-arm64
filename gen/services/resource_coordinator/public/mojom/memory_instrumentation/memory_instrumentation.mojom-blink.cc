...
class HeapProfiler_DumpProcessesForTracing_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<SharedBufferWithSizePtr> in_buffers);
...
bool HeapProfiler_DumpProcessesForTracing_ForwardToCallback::Accept(
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  WTF::Vector<SharedBufferWithSizePtr> p_buffers{};
...
void HeapProfilerAsyncWaiter::DumpProcessesForTracing(
  ...
  proxy_->DumpProcessesForTracing(std::move(strip_path_from_mapped_files),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<SharedBufferWithSizePtr>* out_buffers
,
             WTF::Vector<SharedBufferWithSizePtr> buffers) {*out_buffers = std::move(buffers);
            loop->Quit();
          },
          &loop,
          out_buffers));
...
// static
bool StructTraits<::memory_instrumentation::mojom::blink::SharedBufferWithSize::DataView, ::memory_instrumentation::mojom::blink::SharedBufferWithSizePtr>::Read(
    ::memory_instrumentation::mojom::blink::SharedBufferWithSize::DataView input,
    ::memory_instrumentation::mojom::blink::SharedBufferWithSizePtr* output) {
  bool success = true;
  ::memory_instrumentation::mojom::blink::SharedBufferWithSizePtr result(::memory_instrumentation::mojom::blink::SharedBufferWithSize::New());
