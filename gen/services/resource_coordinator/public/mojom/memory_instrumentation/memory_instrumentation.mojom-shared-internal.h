...
class SharedBufferWithSize_Data;
...
static_assert(sizeof(RawAllocatorDumpEdge_Data) == 40,
...
static_assert(sizeof(RawOSMemDump_Data) == 32,
...
static_assert(sizeof(OSMemDump_Data) == 24,
...
static_assert(sizeof(ProcessMemoryDump_Data) == 40,
...
static_assert(sizeof(GlobalMemoryDump_Data) == 16,
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_SHARED) SharedBufferWithSize_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(SharedBufferWithSize_Data));
      new (data()) SharedBufferWithSize_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    SharedBufferWithSize_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<SharedBufferWithSize_Data>(index_);
    }
    SharedBufferWithSize_Data* operator->() { return data(); }
 ...
 private:
  SharedBufferWithSize_Data();
  ~SharedBufferWithSize_Data() = delete;
};
static_assert(sizeof(SharedBufferWithSize_Data) == 24,
              "Bad sizeof(SharedBufferWithSize_Data)");
// Used by SharedBufferWithSize::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct SharedBufferWithSize_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  SharedBufferWithSize_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~SharedBufferWithSize_UnserializedMessageContext() override = default;
 ...
 private:
  ...
  void Serialize(mojo::internal::SerializationContext* context,
                 mojo::internal::Buffer* buffer) override {
    SharedBufferWithSize_Data::BufferWriter writer;
    mojo::internal::Serialize<DataView>(user_data_, buffer, &writer, context);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    SharedBufferWithSize_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_SHARED) HeapProfiler_DumpProcessesForTracing_ResponseParams_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<internal::SharedBufferWithSize_Data>>> buffers;
