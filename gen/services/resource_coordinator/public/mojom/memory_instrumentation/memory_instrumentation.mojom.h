...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) HeapProfiler
 ...
 public:
  ...
  using DumpProcessesForTracingCallback = base::OnceCallback<void(std::vector<SharedBufferWithSizePtr>)>;
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) SharedBufferWithSize {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedBufferWithSize::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) StructTraits<::memory_instrumentation::mojom::SharedBufferWithSize::DataView,
                                         ::memory_instrumentation::mojom::SharedBufferWithSizePtr> {
  static bool IsNull(const ::memory_instrumentation::mojom::SharedBufferWithSizePtr& input) { return !input; }
  static void SetToNull(::memory_instrumentation::mojom::SharedBufferWithSizePtr* output) { output->reset(); }

  static  decltype(::memory_instrumentation::mojom::SharedBufferWithSize::buffer)& buffer(
       ::memory_instrumentation::mojom::SharedBufferWithSizePtr& input) {
    return input->buffer;
  }

  static decltype(::memory_instrumentation::mojom::SharedBufferWithSize::size) size(
      const ::memory_instrumentation::mojom::SharedBufferWithSizePtr& input) {
    return input->size;
  }

  static const decltype(::memory_instrumentation::mojom::SharedBufferWithSize::pid)& pid(
      const ::memory_instrumentation::mojom::SharedBufferWithSizePtr& input) {
    return input->pid;
  }

  static bool Read(::memory_instrumentation::mojom::SharedBufferWithSize::DataView input, ::memory_instrumentation::mojom::SharedBufferWithSizePtr* output);
};
