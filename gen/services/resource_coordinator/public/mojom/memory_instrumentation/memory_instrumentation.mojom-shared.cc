...
bool RawOSMemDump_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->platform_private_footprint, 2, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->memory_maps, 3, validation_context)) {
    return false;
  }
...
bool GlobalMemoryDump_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->process_dumps, 1, validation_context)) {
    return false;
  }
...
// static
bool SharedBufferWithSize_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const SharedBufferWithSize_Data* object = static_cast<const SharedBufferWithSize_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->pid, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->pid, validation_context))
    return false;
...
SharedBufferWithSize_Data::SharedBufferWithSize_Data()
    : header_({sizeof(*this), 0}) {}
