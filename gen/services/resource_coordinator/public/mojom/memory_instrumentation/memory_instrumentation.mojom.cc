...
SharedBufferWithSize::SharedBufferWithSize()
    : buffer(),
      size(),
      pid() {}
...
SharedBufferWithSize::~SharedBufferWithSize() = default;

bool SharedBufferWithSize::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
...
void ClientProcessProxy::RequestChromeMemoryDump(
  ...
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::ClientProcess::RequestChromeMemoryDump");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::ClientProcess::RequestOSMemoryDump");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool ClientProcess_RequestChromeMemoryDump_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "memory_instrumentation::mojom::ClientProcess::RequestChromeMemoryDumpCallback",
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        ...
        "ClientProcess::RequestChromeMemoryDump response deserializer");
    return false;
  }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::ClientProcess::RequestChromeMemoryDumpCallback",
               "message", message.name());
#endif
...
bool ClientProcess_RequestOSMemoryDump_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "memory_instrumentation::mojom::ClientProcess::RequestOSMemoryDumpCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "ClientProcess::RequestOSMemoryDump response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::ClientProcess::RequestOSMemoryDumpCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::ClientProcess::RequestChromeMemoryDump",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::ClientProcess::RequestOSMemoryDump",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::ClientProcess::RequestChromeMemoryDump",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ClientProcess::RequestChromeMemoryDump deserializer");
        return false;
      }
      ClientProcess::RequestChromeMemoryDumpCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::ClientProcess::RequestOSMemoryDump",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "ClientProcess::RequestOSMemoryDump deserializer");
        return false;
      }
      ClientProcess::RequestOSMemoryDumpCallback callback =
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::HeapProfiler::DumpProcessesForTracing");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
class HeapProfiler_DumpProcessesForTracing_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<SharedBufferWithSizePtr> in_buffers);
...
bool HeapProfiler_DumpProcessesForTracing_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "memory_instrumentation::mojom::HeapProfiler::DumpProcessesForTracingCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  serialization_context.TakeHandlesFromMessage(message);
  bool success = true;
  std::vector<SharedBufferWithSizePtr> p_buffers{};
  HeapProfiler_DumpProcessesForTracing_ResponseParamsDataView input_data_view(params, &serialization_context);
  
  if (!input_data_view.ReadBuffers(&p_buffers))
    success = false;
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "HeapProfiler::DumpProcessesForTracing response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
void HeapProfiler_DumpProcessesForTracing_ProxyToResponder::Run(
  ...
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  typename decltype(params->buffers)::BaseType::BufferWriter
      buffers_writer;
  const mojo::internal::ContainerValidateParams buffers_validate_params(
      0, false, nullptr);
  mojo::internal::Serialize<mojo::ArrayDataView<::memory_instrumentation::mojom::SharedBufferWithSizeDataView>>(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::HeapProfiler::DumpProcessesForTracingCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::HeapProfiler::DumpProcessesForTracing",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::HeapProfiler::DumpProcessesForTracing",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "HeapProfiler::DumpProcessesForTracing deserializer");
        return false;
      }
      HeapProfiler::DumpProcessesForTracingCallback callback =
...
void HeapProfilerAsyncWaiter::DumpProcessesForTracing(
    bool strip_path_from_mapped_files, std::vector<SharedBufferWithSizePtr>* out_buffers) {
  base::RunLoop loop;
  proxy_->DumpProcessesForTracing(std::move(strip_path_from_mapped_files),
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<SharedBufferWithSizePtr>* out_buffers
,
             std::vector<SharedBufferWithSizePtr> buffers) {*out_buffers = std::move(buffers);
            loop->Quit();
          },
          &loop,
          out_buffers));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::HeapProfilerHelper::GetVmRegionsForHeapProfiler");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
bool HeapProfilerHelper_GetVmRegionsForHeapProfiler_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "memory_instrumentation::mojom::HeapProfilerHelper::GetVmRegionsForHeapProfilerCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "HeapProfilerHelper::GetVmRegionsForHeapProfiler response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::HeapProfilerHelper::GetVmRegionsForHeapProfilerCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::HeapProfilerHelper::GetVmRegionsForHeapProfiler",
               "message", message->name());
#endif
      break;
    }
  ...
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::HeapProfilerHelper::GetVmRegionsForHeapProfiler",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "HeapProfilerHelper::GetVmRegionsForHeapProfiler deserializer");
        return false;
      }
      HeapProfilerHelper::GetVmRegionsForHeapProfilerCallback callback =
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::Coordinator::RegisterClientProcess");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDump");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpForPid");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpAndAppendToTrace");
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "memory_instrumentation::mojom::Coordinator::RegisterHeapProfiler");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool Coordinator_RequestGlobalMemoryDump_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "Coordinator::RequestGlobalMemoryDump response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool Coordinator_RequestGlobalMemoryDumpForPid_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpForPidCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "Coordinator::RequestGlobalMemoryDumpForPid response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpForPidCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
bool Coordinator_RequestGlobalMemoryDumpAndAppendToTrace_ForwardToCallback::Accept(
    mojo::Message* message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpAndAppendToTraceCallback",
               "message", message->name());
#endif
  mojo::internal::MessageDispatchContext dispatch_context(message);
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        "Coordinator::RequestGlobalMemoryDumpAndAppendToTrace response deserializer");
    return false;
  }
  if (!callback_.is_null())
    std::move(callback_).Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpAndAppendToTraceCallback",
               "message", message.name());
#endif
  message.set_request_id(request_id_);
  ignore_result(responder_->Accept(&message));
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RegisterClientProcess",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "Coordinator::RegisterClientProcess deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDump",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpForPid",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpAndAppendToTrace",
               "message", message->name());
#endif
      break;
    }
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RegisterHeapProfiler",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "Coordinator::RegisterHeapProfiler deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
  ...
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDump",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "Coordinator::RequestGlobalMemoryDump deserializer");
        return false;
      }
      Coordinator::RequestGlobalMemoryDumpCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpForPid",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "Coordinator::RequestGlobalMemoryDumpForPid deserializer");
        return false;
      }
      Coordinator::RequestGlobalMemoryDumpForPidCallback callback =
  ...
  TRACE_EVENT1("mojom", "(Impl)memory_instrumentation::mojom::Coordinator::RequestGlobalMemoryDumpAndAppendToTrace",
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "Coordinator::RequestGlobalMemoryDumpAndAppendToTrace deserializer");
        return false;
      }
      Coordinator::RequestGlobalMemoryDumpAndAppendToTraceCallback callback =
...
// static
bool StructTraits<::memory_instrumentation::mojom::SharedBufferWithSize::DataView, ::memory_instrumentation::mojom::SharedBufferWithSizePtr>::Read(
    ::memory_instrumentation::mojom::SharedBufferWithSize::DataView input,
    ::memory_instrumentation::mojom::SharedBufferWithSizePtr* output) {
  bool success = true;
  ::memory_instrumentation::mojom::SharedBufferWithSizePtr result(::memory_instrumentation::mojom::SharedBufferWithSize::New());
