...
class PageSignalReceiver_NotifyPageAlmostIdle_ParamsDataView {
 public:
  ...
  inline void GetPageCuIdDataView(
      ::resource_coordinator::mojom::CoordinationUnitIDDataView* output);

  template <typename UserType>
  WARN_UNUSED_RESULT bool ReadPageCuId(UserType* output) {
    auto* pointer = data_->page_cu_id.Get();
...
class PageSignalReceiver_NotifyNonPersistentNotificationCreated_ParamsDataView {
 public:
  PageSignalReceiver_NotifyNonPersistentNotificationCreated_ParamsDataView() {}

  PageSignalReceiver_NotifyNonPersistentNotificationCreated_ParamsDataView(
      internal::PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data* data,
      mojo::internal::SerializationContext* context)
      : data_(data), context_(context) {}
 ...
 private:
  internal::PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data* data_ = nullptr;
  mojo::internal::SerializationContext* context_ = nullptr;
};
...
inline void PageSignalReceiver_NotifyPageAlmostIdle_ParamsDataView::GetPageCuIdDataView(
    ::resource_coordinator::mojom::CoordinationUnitIDDataView* output) {
  auto pointer = data_->page_cu_id.Get();
...
inline void PageSignalReceiver_SetExpectedTaskQueueingDuration_ParamsDataView::GetPageCuIdDataView(
    ::resource_coordinator::mojom::CoordinationUnitIDDataView* output) {
  auto pointer = data_->page_cu_id.Get();
  *output = ::resource_coordinator::mojom::CoordinationUnitIDDataView(pointer, context_);
}
...
inline void PageSignalReceiver_SetLifecycleState_ParamsDataView::GetPageCuIdDataView(
    ::resource_coordinator::mojom::CoordinationUnitIDDataView* output) {
  auto pointer = data_->page_cu_id.Get();
  *output = ::resource_coordinator::mojom::CoordinationUnitIDDataView(pointer, context_);
}
...
inline void PageSignalReceiver_NotifyNonPersistentNotificationCreated_ParamsDataView::GetPageCuIdDataView(
    ::resource_coordinator::mojom::CoordinationUnitIDDataView* output) {
  auto pointer = data_->page_cu_id.Get();
  *output = ::resource_coordinator::mojom::CoordinationUnitIDDataView(pointer, context_);
}
