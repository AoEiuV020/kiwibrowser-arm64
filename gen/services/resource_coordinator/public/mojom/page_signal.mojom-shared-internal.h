...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_SHARED) PageSignalReceiver_NotifyPageAlmostIdle_Params_Data {
 public:
  ...
  mojo::internal::Pointer<::resource_coordinator::mojom::internal::CoordinationUnitID_Data> page_cu_id;
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_SHARED) PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data {
 public:
  class BufferWriter {
   public:
    BufferWriter() = default;
    ...
    void Allocate(mojo::internal::Buffer* serialization_buffer) {
      serialization_buffer_ = serialization_buffer;
      index_ = serialization_buffer_->Allocate(sizeof(PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data));
      new (data()) PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data();
    }

    bool is_null() const { return !serialization_buffer_; }
    PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data* data() {
      DCHECK(!is_null());
      return serialization_buffer_->Get<PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data>(index_);
    }
    PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data* operator->() { return data(); }
 ...
 private:
  PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data();
  ~PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data() = delete;
};
static_assert(sizeof(PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data) == 16,
              "Bad sizeof(PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data)");
