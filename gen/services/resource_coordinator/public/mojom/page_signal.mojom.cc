...
void PageSignalReceiverProxy::NotifyPageAlmostIdle(
    const ::resource_coordinator::CoordinationUnitID& in_page_cu_id) {
...
void PageSignalReceiverProxy::SetExpectedTaskQueueingDuration(
    const ::resource_coordinator::CoordinationUnitID& in_page_cu_id, base::TimeDelta in_duration) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PageSignalReceiverProxy::SetLifecycleState(
    const ::resource_coordinator::CoordinationUnitID& in_page_cu_id, ::resource_coordinator::mojom::LifecycleState in_state) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool PageSignalReceiverStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)resource_coordinator::mojom::PageSignalReceiver::NotifyPageAlmostIdle",
      ...
      bool success = true;
      ::resource_coordinator::CoordinationUnitID p_page_cu_id{};
...
void PageSignalReceiverInterceptorForTesting::NotifyPageAlmostIdle(const ::resource_coordinator::CoordinationUnitID& page_cu_id) {
  GetForwardingInterface()->NotifyPageAlmostIdle(std::move(page_cu_id));
}
void PageSignalReceiverInterceptorForTesting::SetExpectedTaskQueueingDuration(const ::resource_coordinator::CoordinationUnitID& page_cu_id, base::TimeDelta duration) {
  GetForwardingInterface()->SetExpectedTaskQueueingDuration(std::move(page_cu_id), std::move(duration));
}
void PageSignalReceiverInterceptorForTesting::SetLifecycleState(const ::resource_coordinator::CoordinationUnitID& page_cu_id, ::resource_coordinator::mojom::LifecycleState state) {
  GetForwardingInterface()->SetLifecycleState(std::move(page_cu_id), std::move(state));
}
void PageSignalReceiverInterceptorForTesting::NotifyNonPersistentNotificationCreated(const ::resource_coordinator::CoordinationUnitID& page_cu_id) {
