...
bool PageSignalReceiver_NotifyPageAlmostIdle_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->page_cu_id, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->page_cu_id, validation_context))
    return false;
...
// static
bool PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data* object = static_cast<const PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data*>(data);
...
PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data::PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data()
    : header_({sizeof(*this), 0}) {}
