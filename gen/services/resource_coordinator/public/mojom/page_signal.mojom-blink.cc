...
void PageSignalReceiverProxy::NotifyPageAlmostIdle(
    ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr in_page_cu_id) {
  ...
  typename decltype(params->page_cu_id)::BaseType::BufferWriter
      page_cu_id_writer;
  mojo::internal::Serialize<::resource_coordinator::mojom::CoordinationUnitIDDataView>(
      in_page_cu_id, buffer, &page_cu_id_writer, &serialization_context);
  params->page_cu_id.Set(
      page_cu_id_writer.is_null() ? nullptr : page_cu_id_writer.data());
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->page_cu_id.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null page_cu_id in PageSignalReceiver.NotifyPageAlmostIdle request");
...
void PageSignalReceiverProxy::SetExpectedTaskQueueingDuration(
    ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr in_page_cu_id, WTF::TimeDelta in_duration) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->page_cu_id.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null page_cu_id in PageSignalReceiver.SetExpectedTaskQueueingDuration request");
...
void PageSignalReceiverProxy::SetLifecycleState(
    ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr in_page_cu_id, ::resource_coordinator::mojom::blink::LifecycleState in_state) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->page_cu_id.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null page_cu_id in PageSignalReceiver.SetLifecycleState request");
...
void PageSignalReceiverProxy::NotifyNonPersistentNotificationCreated(
    ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr in_page_cu_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "resource_coordinator::mojom::PageSignalReceiver::NotifyNonPersistentNotificationCreated");
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
  ...
  mojo::Message message(
      internal::kPageSignalReceiver_NotifyNonPersistentNotificationCreated_Name, kFlags, 0, 0, nullptr);
  auto* buffer = message.payload_buffer();
  ::resource_coordinator::mojom::internal::PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data::BufferWriter
      params;
  mojo::internal::SerializationContext serialization_context;
  params.Allocate(buffer);
  typename decltype(params->page_cu_id)::BaseType::BufferWriter
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      params->page_cu_id.is_null(),
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null page_cu_id in PageSignalReceiver.NotifyNonPersistentNotificationCreated request");
  message.AttachHandlesFromSerializationContext(
      &serialization_context);
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
...
bool PageSignalReceiverStubDispatch::Accept(
  ...
  TRACE_EVENT1("mojom", "(Impl)resource_coordinator::mojom::PageSignalReceiver::NotifyPageAlmostIdle",
      ...
      bool success = true;
      ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr p_page_cu_id{};
      PageSignalReceiver_NotifyPageAlmostIdle_ParamsDataView input_data_view(params, &serialization_context);
      
      if (!input_data_view.ReadPageCuId(&p_page_cu_id))
        success = false;
      if (!success) {
...
std::move(p_state));
    ...
    case internal::kPageSignalReceiver_NotifyNonPersistentNotificationCreated_Name: {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1("mojom", "(Impl)resource_coordinator::mojom::PageSignalReceiver::NotifyNonPersistentNotificationCreated",
               "message", message->name());
#endif
      mojo::internal::MessageDispatchContext context(message);

      DCHECK(message->is_serialized());
      internal::PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data* params =
          reinterpret_cast<internal::PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data*>(
              message->mutable_payload());
      ...
      bool success = true;
      ::resource_coordinator::mojom::blink::CoordinationUnitIDPtr p_page_cu_id{};
      PageSignalReceiver_NotifyNonPersistentNotificationCreated_ParamsDataView input_data_view(params, &serialization_context);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            "PageSignalReceiver::NotifyNonPersistentNotificationCreated deserializer");
        return false;
      }
      // A null |impl| means no implementation was bound.
      assert(impl);
      impl->NotifyNonPersistentNotificationCreated(
std::move(p_page_cu_id));
      return true;
    }
  }
...
bool PageSignalReceiverRequestValidator::Accept(mojo::Message* message) {
  ...
  switch (message->header()->name) {
    ...
    case internal::kPageSignalReceiver_NotifyNonPersistentNotificationCreated_Name: {
      ...
      if (!mojo::internal::ValidateMessagePayload<
               internal::PageSignalReceiver_NotifyNonPersistentNotificationCreated_Params_Data>(
                  message, &validation_context)) {
        return false;
      }
      return true;
...
void PageSignalReceiverInterceptorForTesting::NotifyPageAlmostIdle(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id) {
  GetForwardingInterface()->NotifyPageAlmostIdle(std::move(page_cu_id));
}
void PageSignalReceiverInterceptorForTesting::SetExpectedTaskQueueingDuration(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id, WTF::TimeDelta duration) {
  GetForwardingInterface()->SetExpectedTaskQueueingDuration(std::move(page_cu_id), std::move(duration));
}
void PageSignalReceiverInterceptorForTesting::SetLifecycleState(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id, ::resource_coordinator::mojom::blink::LifecycleState state) {
  GetForwardingInterface()->SetLifecycleState(std::move(page_cu_id), std::move(state));
}
void PageSignalReceiverInterceptorForTesting::NotifyNonPersistentNotificationCreated(::resource_coordinator::mojom::blink::CoordinationUnitIDPtr page_cu_id) {
  GetForwardingInterface()->NotifyNonPersistentNotificationCreated(std::move(page_cu_id));
}
